...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      id: 5,
      title: 'Music Hit Classifier',
      category: 'Machine Learning & Data Science',
      type: 'ml',
      timeline: 'Nov 2024 - Dec 2024',
      role: 'ML Engineer & Data Scientist',
      shortDescription: 'Binary classification system predicting song hit potential using audio features, artist popularity metrics, and engagement data from multiple APIs.',
      fullDescription: 'End-to-end machine learning project that predicts whether songs will become hits (popularity ≥60) using Random Forest classification. Integrated data from Kaggle, Spotify API, and Last.fm API to analyze 250 songs across 85+ genres. Achieved 85-90% accuracy while identifying "hidden gems" - high-quality songs with low visibility.',
      challenge: 'Build accurate hit prediction model using limited dataset (250 songs) while addressing class imbalance, preventing data leakage, and identifying underrated songs with commercial potential.',
      solution: 'Multi-source data pipeline combining Spotify audio features with API-collected artist metrics and Last.fm engagement data. Implemented feature engineering, balanced class weights, and ensemble learning with Random Forest to achieve robust predictions.',
      impact: [
        'Achieved 85-90% accuracy on unseen test data with balanced predictions',
        'Identified 38+ "hidden gems" - high-quality songs from emerging artists',
        'Processed 250 songs with 16 features from 3 data sources',
        'Built interactive Streamlit web app for real-time predictions',
        'Demonstrated artist popularity matters more than song quality (25% vs 15% feature importance)'
      ],
      responsibilities: [
        'Integrated data from Kaggle Spotify dataset, Spotify Web API, and Last.fm API',
        'Built data collection pipeline using spotipy library and REST APIs',
        'Implemented rate limiting and error handling for API calls (150 songs in 2-3 minutes)',
        'Engineered features: quality_index (danceability+energy+valence), visibility_score (plays/followers)',
        'Applied MinMaxScaler for feature normalization across different scales',
        'Created binary target variable with optimized threshold (popularity ≥60) for class balance',
        'Trained Decision Tree (78-85% accuracy) and Random Forest (85-90% accuracy) classifiers',
        'Implemented stratified train-test split (80/20) with class_weight balancing',
        'Evaluated models using accuracy, precision, recall, F1-score, and confusion matrices',
        'Analyzed feature importance revealing artist_followers as top predictor (19.6%)',
        'Built interactive Streamlit application with single/batch prediction capabilities',
        'Created comprehensive visualizations: confusion matrices, feature importance, radar charts',
        'Saved trained model using joblib for deployment and reproducibility',
        'Debugged 100% accuracy issue by identifying and fixing class imbalance',
        'Documented entire pipeline in Jupyter notebooks with detailed explanations'
      ],
      tools: [
        'Python', 
        'scikit-learn', 
      ...
      color: 'peach',
      hasLiveDemo: true,
      liveDemo: 'https://your-streamlit-app-url-here.streamlit.app', // Add if you deploy to Streamlit Cloud
      hasGithub: true,
      githubUrl: 'https://github.com/simmcodes/Music-Hit-Classifier'
    },
    {
      id: 6,
